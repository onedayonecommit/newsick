      ...
      <div className="topSection">
        ...
        <div className="infoSwiperSection">
          <motion.div drag="x" dragConstraints={{ right: 0, left: -510 }} className="frameBox">
            {nftData.map((item) => (
              <motion.div className="nftInfoBox" whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.9 }}>
      ...
      <div className="bottomSection">
        ...
        <div className="orderSection">
          <div className="categorySection">
            <div className={`tab ${selectedTab === "buy" ? "selected" : "unSelected"}`} onClick={() => handleTabClick("buy")}>
              매수
              {selectedTab === "buy" && <motion.div className="underline" layoutId="underline" transition={{ duration: 0.2, type: "spring" }} />}
            </div>
            <div className={`tab ${selectedTab === "sell" ? "selected" : "unSelected"}`} onClick={() => handleTabClick("sell")}>
              매도
              {selectedTab === "sell" && <motion.div className="underline" layoutId="underline" transition={{ duration: 0.2, type: "spring" }} />}
            </div>
            <div className={`tab ${selectedTab === "history" ? "selected" : "unSelected"}`} onClick={() => handleTabClick("history")}>
              거래내역
              {selectedTab === "history" && <motion.div className="underline" layoutId="underline" transition={{ duration: 0.2, type: "spring" }} />}
            </div>
          </div>
          {selectedTab === "buy" && (
            <motion.div className="inputSection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
              <div className="inputList">
                <motion.div className="canOrderPriceSection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2, delay: 0.1 }}>
                ...
                <motion.div className="buyPriceSection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2, delay: 0.2 }}>
                  <div className="leftSection">
                ...
                <motion.div className="orderQuantitySection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2, delay: 0.3 }}>
                  <div className="leftSection">
                ...
                <motion.div className="orderPriceSection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2, delay: 0.4 }}>
                  <div className="leftSection">
          ...
          {selectedTab === "history" && (
            <motion.div className="scrollSection" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.2 }}>
              {historyItem.map((history, index) => (
                <motion.div className="historyItemBox" initial={{ x: 100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.3, type: "spring", delay: 0.1 * index }}>
