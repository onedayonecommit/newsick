  ...
  return (
    <motion.div className='searchTotalFrame'>
        ...
        <div className='switchListBox'>
            <motion.div className='optionFunding' animate={animation}  >펀딩 리스트</motion.div>
            <motion.div className='optionMusic' animate={animation} >음악</motion.div>
            <motion.div className='optionNftMusic' animate={animation} >음악(NFT)</motion.div>
            <motion.div className='optionNft'animate={animation} >NFT</motion.div>
            <motion.div className='optionDum' animate={animation} >혹시 몰라서</motion.div>
        </div>
