      ...
      <div className='topSection'>
        <div className='titleMusicInfoFrame'>
          ...
          <div className='musicSellButtonSection'>
            <div className='playButton' typeof='button'>PLAY NOW</div>
            <div className='buyButton' typeof='button'>BUY NOW</div>
          </div>
        </div>
        <div className='subTitleMusicinfoFram'>
          ...
          <div className='subInfoBoxList'>
            {subMusicItems.map((item)=>(
                  ...
                  <img className='musicImg' src={item.img} alt={item.songName}/>
          ...
          <div className='topChartList'>
            {
              ...
              <div className='musicFrontSection'>
                <img className='musicImg' src={item.img} alt={item.singerName}/>
                <div className='musicInfo'>
          ...
          <div className='genreSection'>
            ...
            <div className='genreButtonSection'>
              <div className='genreButtonList'>
                {
                  GenreItems.map((item)=>(
                        <div className='genreItemBox' style={{backgroundImage: `url(${item.img})`}} aria-label={item.genreName}>
                        <div className='genreInfoSection'>
