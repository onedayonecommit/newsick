...
const FundingCreateContainer = () => {
  ...
  const convertToISO8601 = (e) => {
    ...
    return setDate(selectDate.toISOString());
  };
  console.log("펀딩기간", date);
  console.log("장르", dropDown);
      ...
      <div className="mainContentSection">
        <div className="contentSection">
          ...
          <div className="fundingPeriodSection">
            <div>
              ...
              <div className="fundingPeriodFrame">
                <input type="date" onChange={convertToISO8601} />
                ~
                <input type="date" onChange={convertToISO8601} />
              </div>
            </div>
          ...
          <div className="representativeImageSection">
            ...
            <div className="rightSection">
              ...
              <div className="submissionFrame">
                <motion.div className="submissionButton" whileTap={{ y: 8 }} onClick={clickSubmission} style={isSubmissionButton ? { color: "rgba(255, 255, 255, 1)", boxShadow: "none", backgroundColor: "rgba(0,0, 0, 1)" } : ""}>
                  확정
                </motion.div>
              </div>
            </div>
          ...
          <div className="genreSection">
            <motion.div className="dropDownBox" variants={slideVerticalAnimation} initial={!dropDown ? "open" : "close"} animate={!dropDown ? "close" : "open"}>
