...
export const fetchPopularPick = createAsyncThunk("fund/popularPick", async () => {
  try {
    const _recieveData = await axios.post("https://www.poopoobin.com/hot-fund/top1");
...
export const fetchBringData = createAsyncThunk("fund/allList", async () => {
  try {
    const _recieveData = await axios.post("https://www.poopoobin.com/hot-fund/all/list");
